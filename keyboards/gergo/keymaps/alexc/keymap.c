...
[BASE] = LAYOUT_gergo(
    ...
    MT(MOD_LCTL, KC_BSPC),  KC_A,  KC_S,   KC_D,   KC_F, KC_G, KC_VOLU,                       KC_PGUP,  KC_H,    KC_J, KC_K, KC_L,   KC_SCLN, KC_QUOT,
    KC_LSFT,                KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_VOLD, KC_LEFT,     KC_RIGHT, KC_PGDOWN,  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
  KC_BSPC, KC_SPC, MO(SYMB), MO(NUMB),    MO(SYMB), LT(NUMB, KC_TAB), KC_SPC, KC_ENT
    ),
